...
config = {
  ...
  version = 8, -- [!code ++] Config version. Do not change.
  general = {
  ...
  modules = { -- HUD Modules
    ...
    land = { -- HUD Module for Landcraft
      ...
      fuel = { -- Landcraft specific options for the built-in fuel script
        electric_gauge = false, -- [!code ++] Show fuel gauge for electric vehicles (default: false)
    ...
    info = { -- HUD Module for Roleplay Info
      ...
      priority = { -- Priority sub-module
        ...
        hide_username = false, -- [!code ++] Hide username in priority status (default: false)
        messages = {
    ...
    player = { -- HUD Module for Player
      ...
      oxygen = true, -- [!code ++] Show oxygen level when swimming underwater (default: true)
      messages = {
